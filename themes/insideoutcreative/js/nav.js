...
let secondaryLogo = document.querySelector('#secondaryLogo');
...
function changeLogo() {
    if (scrollY < 299) {
        ...
        secondaryLogo.classList.add('inactive');
        secondaryLogo.classList.remove('active');
    } else if (scrollY > 300) {
        secondaryLogo.classList.add('active');
        secondaryLogo.classList.remove('inactive');
